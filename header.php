            ...
            <div class="container">
                ...
                <div class="header-navibox-2">
                    <ul class="yamm main-menu nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="service.php" data-toggle="dropdown" class="dropdown-toggle">Services<b class="caret"></b></a>
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="themeParty.php">Theme Party Planning</a></li>
                        ...
                        <li class="dropdown">
                            <a href="theme.php" data-toggle="dropdown" class="dropdown-toggle">Themes<b class="caret"></b></a>
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="theme.php">Girl's Birthday</a></li>
                                <li><a href="theme.php">Boy's Birthday</a></li>
                                <li><a href="theme.php">Wedding Anniversary</a></li>
                                <li><a href="theme.php">Family Function</a></li>
                                <li><a href="theme.php">Other Parties</a></li>
                            </ul>
                        </li>
                        <li><a href="gallery.php">Gallery</a></li>
                        <li><a href="contact.php">Contact</a></li>
