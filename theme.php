                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="text-center">
                            <h2 class="ui-title-block ui-title-block_weight_normal"><span class="text-primary"> Customized Themes</span> of Your Choice</h2>
                            <div class="ui-subtitle-block">From Wedding Functions to Birthday Parties or Corporate Events to Musical Functions, We offer full range of different types of themes according to your wants and thoughts.</div>
                        </div>
                    </div>
                </div>
                <div class="row">
